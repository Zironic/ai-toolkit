...
from .videox_attention_utils import attention
from .videox_dist_stub import (ZMultiGPUsSingleStreamAttnProcessor, get_sequence_parallel_rank,
                                get_sequence_parallel_world_size)

# Stub for get_sp_group (not needed for single-GPU)
def get_sp_group():
    return None
