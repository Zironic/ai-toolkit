...
> This is a historical predecessor plan: its commands, flags, file paths, and
> symbols are archival and are not expected to run. The supported behavior is
> documented in `docs/ARENA_OFFLOAD_CONTRACT.md`.
