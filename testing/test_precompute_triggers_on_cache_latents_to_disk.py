...
def test_precompute_runs_when_cache_latents_to_disk(tmp_path):
    # dataset flag: cache_latents_to_disk should enable control-context caching/persistence by default
    cfg = DatasetConfig(dataset_path=str(tmp_path), cache_latents_to_disk=True)

    # sanity check: defaults derived
