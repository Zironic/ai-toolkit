      ...
      >
        ...
        <div className={topBarClass}>
          ...
          <Card title="Save">
            ...
            />
            <NumberInput
              label="Recovery Snapshot Every"
              value={jobConfig.config.process[0].save.recovery_every}
              onChange={value => setJobConfig(value, 'config.process[0].save.recovery_every')}
