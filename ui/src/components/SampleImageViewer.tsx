          ...
          >
            ...
            <div className="bg-gray-950 text-sm flex justify-between items-center px-4 py-2">
              ...
              <div className="text-xs">
                <div>
                  <span className="text-gray-400">Step:</span> <span className="text-gray-100">{imgInfo.step.toLocaleString()}</span>
                </div>
                <div>
                  <span className="text-gray-400">Sample #:</span> <span className="text-gray-100">{imgInfo.promptIdx + 1}</span>
                </div>
                <div>
                  <span className="text-gray-400">Seed:</span> <span className="text-gray-100">{seed}</span>
                </div>
              </div>
            </div>
